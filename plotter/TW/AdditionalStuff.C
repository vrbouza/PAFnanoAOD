...
//
//
//   if      (BDT < -0.533208   ) return 1;
//   else if (BDT < -0.413607   ) return 2;
//   else if (BDT < -0.303425   ) return 3;
//   else if (BDT < -0.207887   ) return 4;
//   else if (BDT < -0.1178     ) return 5;
//   else if (BDT < -0.0234394  ) return 6;
//   else if (BDT < 0.0839077   ) return 7;
//   else if (BDT < 0.216577    ) return 8;
//   else if (BDT < 0.341121    ) return 9;
//   else                       return 10;
//
//
//
...
//   // else                        return 6;
//
//   if      ( BDT < -0.177842 ) return 1;
//   else if ( BDT < -0.0812217) return 2;
//   else if ( BDT < -0.0102911) return 3;
//   else if ( BDT < 0.0418608 ) return 4;
//   else if ( BDT < 0.106614  ) return 5;
//   else                         return 6;
//
//
// }
//
// // Float_t Case2(Double_t TNJets , Double_t TNBtags , Double_t TBDT, Double_t TBDT2j1t )
// // {
// //   if (TNJets == 1 && TNBtags == 1) return theBDt( TBDT )-1; // de 0 a 9 (BDT de 1 a 10)
// //   if (TNJets == 2 && TNBtags == 1) return the2j1tBDt( TBDT2j1t )+9; // de 10 a 15 (2j1t de 1 a 6)
//
// // }
//
//
...
// }
//
// Float_t JetOverFlow( Double_t jetpt)
// {
//   if (jetpt > 180.) return 180.;
//   else return jetpt;
// }
//
//
...
// Float_t Case2( Double_t TNJets , Double_t TNBtags , Double_t TBDT , Double_t TBDT2j1t)
// {
//   if (TNJets == 2 && TNBtags == 1) return the2j1tBDt( TBDT2j1t )-1; // the2j1t esta entre 1 y 6 (entre 0 y 5)
//   else if (TNJets == 1 && TNBtags == 1) return theBDt(TBDT)+5;  // entre 6 y 15 (thBDt esta entre 1 y 10)
//   else return -1;
// }
//
// Float_t Case4( Double_t TNJets , Double_t TNBtags , Double_t TBDT )
// {
...
//     return theBDt( TBDT )+1;                 // entre 2 y 11 (BDT entre 1 y 10)
//   else return -1;
//
// }
//
...
// }
//
// Float_t Case5(Double_t nJet, Double_t nBtag, Double_t bdt, Double_t bdt2j1t)
// {
...
Float_t nJetsnBs(Float_t TNJets, Float_t TNBtags) {
  if (TNJets < 3)
